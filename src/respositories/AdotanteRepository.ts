...
export default class AdotanteRepository implements InterfaceAdotanteRepository {
  ...
  async atualizaEnderecoAdotante(
    ...
    const adotante = await this.repository.findOne({ //buscando no bd o id correspondente
      where: { id: idAdotante },
    });
    ...
    const novoEndereco = new EnderecoEntity(endereco.cidade, endereco.estado); //Passando campos obrigátorio de
    adotante.endereco = novoEndereco;                                          //enderecoEntity
